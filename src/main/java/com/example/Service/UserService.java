...
public interface UserService {
    ...
    UserDTO getUser(String username, Long myID);
    ...
    CombinedDTO getRecentTweetsByUser(String username, Long myID, boolean asc, int page, int count);
    CombinedDTO getLikedTweetsByUser(String username, Long myID, boolean asc, int withinDays, int page, int count);
    CombinedDTO getRepliedTweetsByUser(String username, Long myID, boolean asc, int withinDays, int page, int count);
